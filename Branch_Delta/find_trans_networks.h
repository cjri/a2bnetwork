...
void CheckLikelihood(int& check_unlike, run_params& p, const vector<int>& index, const vector< vector<tpair> >& allsets, const  vector< vector<ijlike> >& like_trans); //Now redundant...?
